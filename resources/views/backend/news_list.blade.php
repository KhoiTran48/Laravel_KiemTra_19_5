    ...
    <div id="top">
        ...
        <div id="menu">
            <table width="100%">
                <tr>
                    <td>
                        <a href="{{ route('list')}}">Trang chính</a> | <a href="{{ route('add') }}">Thêm tin</a>
                    </td>
                    <td align="right">
    ...
    <div id="main">
		<table class="list_table">
			...
			<tr class="list_data">
                ...
                <td class="list_td aligncenter">{{ $item['tenTieuDe'] }}</td>
                <td class="list_td aligncenter">{{ $item['tacGia'] }}</td>
				<td class="list_td aligncenter">{{ $item['created_at'] }}</td>
                <td class="list_td aligncenter">
                    <a href="{{ route('destroy',['id'=>$item['id']])}}"><img src="images/edit.png" /></a>&nbsp;&nbsp;&nbsp;
                    <a href="{{ route('edit',['id'=>$item['id']])}}"><img src="images/delete.png" /></a>
                </td>
            </tr>
			@endforeach
